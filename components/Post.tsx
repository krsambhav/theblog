...
export default function Post() {
  return (
    <div className="post-main-container w-full md:w-[90%] h-fit md:h-[300px] flex flex-col items-center justify-center md:flex-row border border-black p-5 md:p-10 transition-all duration-200 hover-shadow">
      ...
      <div className="post-data-container flex flex-col md:ml-10 mt-10 md:mt-0 items-center">
        ...
        <div className="post-btns container w-[80px] h-[35px] bg-black rounded-xl mt-5 hidden md:flex flex-row justify-center items-center self-end">
          <HiOutlineBookOpen className="text-white" />
        </div>
      </div>
    </div>
  );
